            ...
            return (
                <React.Fragment>
                    ...
                    <ul className="list-group mt-3">
                        ...
                        <li className="list-group-item">
                            <strong>Genre</strong>: {track.primary_genres.music_genre_list.length > 0 ? track.primary_genres.music_genre_list[0].music_genre.music_genre_name : 'No Genre Available'}
                        </li>
                        <li className="list-group-item">
